...
if __name__ == "__main__":
    ...
    parser.add_argument('--dst_trials_path', help='dst_trials_path', type=str, default="data/trial.lst")
    ...
    for item in trials:
        enroll_path = os.path.join(args.voxceleb1_root, "voxceleb1_wav", item[1])
        test_path = os.path.join(args.voxceleb1_root, "voxceleb1_wav", item[2])
